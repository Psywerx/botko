REPOSTS = [
            ...
            "Strong with the force %(nick)s is not. Already posted by %(repostNick)s, this link was.",
            "Strong with the force %(nick)s is not. Already posted %(repostNick)s this link has.",
